...
// Top-nav glyphs — one consistent stroke language (2px, rounded, 24-grid,
// currentColor) matching the header gear, so the active tab's accent flows
// through. Watching reuses the same bookmark as the scene-card watch
// control, tying the nav to the feature.
